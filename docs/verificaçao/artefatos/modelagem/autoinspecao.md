...
|----|-----------|-------|-------|--------|
|**Cenários** |
| 1  | Os cenários possuem um título claro e descritivo. |Sim|1.1|10/02/2025|
| 2 | Os atores envolvidos no cenárioestão claramente identificados. |Sim|1.1|10/02/2025|
| 3 | O contexto em que o cenário se desenrola é descrito de forma detalhada. |Sim|1.1|10/02/2025|
| 4 | As ações dos atores são descritas de forma observável e sequencial. |Sim|1.1|10/02/2025|
| 5 | O planejamento das ações necessárias para alcançar o objetivo está claramente descrito no cenário. |Sim|1.1|10/02/2025|
| 6 | Os cenários elaborados envolvem as principais ações que os usuário vão realizar, e com maior frequência. |Sim|1.1|10/02/2025|
| 7 | Os cenários apresentam: ambiente/contexto, atores, objetivos, planejamento, ações, eventos e avaliação. |Não|1.1|10/02/2025|
| 8 | Os cenários são uma história sobre pessoas realizando uma atividade, uma narrativa, textual ou pictórica, concreta, rica em detalhes.  |Sim|1.1|10/02/2025|
| **Léxicos** |
| 9 | Há definição do usuário nos Léxicos? |Não|1.1|10/02/2025|
| 10 | Os léxicos possuem ligações entre si (hiper links)? |Sim|1.1|10/02/2025|
| 11 | Os léxicos utilizam a estrutura de dicionário (verbo, objeto, estado)?  |Sim|1.1|10/02/2025|
| **Casos de Uso** |
| 12 | Todos os elementos necessários para a criação do diagrama de caso de uso estão sendo mostrados? (atores, relacionamentos, sistemas e casos de uso) |Sim|1.0|10/02/2025|
| 13  | Os atores principais e atores secundários no diagrama de caso de uso? |Sim|1.0|10/02/2025|
| 14 |  O ator principal está do lado esquerdo do sistema no diagrama de caso de uso? |Sim|1.0|10/02/2025|
| 15 | Os atores estão fora da caixa de limite do sistema no diagrama de caso de uso? |Sim|1.0|10/02/2025|
| 16 | A especificação do diagrama de caso de uso (com Nome, Descrição, Atores, Pré-Condição,Pós-Condição, Fluxo Principal, Fluxo Alternativo e Fluxo de Exceção etc.)?|Sim|1.0|10/02/2025|
| 17 | O nome da aplicação está no topo do sistema? |Sim|1.0|10/02/2025|
| 18 |O ator recebe um nome devidamente ligado a quem ele é? (Pessoa, Cliente, Organização, Outro sistema, Dispositivo externo) |Sim|1.0|10/02/2025|
| 19 |  Está sendo usado verbos no infinitivo para mostras os casos de uso?  |Sim|1.0|10/02/2025|
| **Especificação Suplementar** |
| 20 | Há especificação suplementar? |Sim|1.2|10/02/2025|
| 21 |  O artefato segue o modelo FURPS+? |Sim|1.2|10/02/2025|
| 22 |  O documento especifica o tempo de resposta, no Desempenho? |Sim|1.2|10/02/2025|
| 23 | O documento especifica qual plataforma o aplicativo pode ser executado? |Sim|1.2|10/02/2025|
