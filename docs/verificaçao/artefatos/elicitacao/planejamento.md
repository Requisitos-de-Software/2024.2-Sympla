...
Assim esse documento realiza a construção fundamentada da lista de verificação para os métodos de Elicitação.
...
## Lista de Verificação - Técnicas de Elicitação

Na Tabela 1 é apresentada a lista de verificação construída conforme a metodologia acima.

<font size="3"><p style="text-align: center">Tabela 1: Lista de Verificação Planejada - Técnicas de Elicitação</p></font>

| ID | Descrição | Autor | Fonte | Imagem |
|----|-----------|-------|-------|--------|
| **Entrevista** |
| 1  | A entrevista foi guiada por perguntas ou tópicos seguindo um roteiro? | Milena Rocha | IHC-UX. Capítulo 7. Disponível em: [link](https://aprender3.unb.br/pluginfile.php/2972450/mod_resource/content/4/ihc-ux%20cap%207.pdf). Acesso em: 18 jan. 2025. | [Imagem](./assets/1.png) |
| 2 | O entrevistador evita influenciar o entrevistado? | Milena Rocha | IHC-UX. Capítulo 7. Disponível em: [link](https://aprender3.unb.br/pluginfile.php/2972450/mod_resource/content/4/ihc-ux%20cap%207.pdf). Acesso em: 18 jan. 2025. | [Imagem](./assets/2.png) |
| 3 | As perguntas da entrevista foram formuladas de forma clara e direta, evitando questões longas ou complexas que possam causar confusão ao entrevistado. | Milena Rocha, Gabriel Scheidt | IHC-UX. Capítulo 7. Disponível em: [link](https://aprender3.unb.br/pluginfile.php/2972450/mod_resource/content/4/ihc-ux%20cap%207.pdf). Acesso em: 18 jan. 2025. | [Imagem](./assets/3.png) |
| 4 | O objetivo da entrevista e as informações a serem buscadas são definidos claramente no início do processo de elicitação. | Rafael Pereira, Victor Hugo, Gabriel Scheidt | VÁZQUEZ, Carlos Eduardo; SIMÕES, Guilherme Siqueira. Engenharia de requisitos: software orientado ao negócio. 1. ed. Rio de Janeiro: Brasport, 2016. 328 p. ISBN 978-85-7452-790-1. | [Imagem](./assets/4.png) |
| 5 | Aspectos importantes são registrados para que não se percam durante a entrevista. | Rafael Pereira, Renan Araújo | VÁZQUEZ, Carlos Eduardo; SIMÕES, Guilherme Siqueira. Engenharia de requisitos: software orientado ao negócio. 1. ed. Rio de Janeiro: Brasport, 2016. 328 p. ISBN 978-85-7452-790-1. | [Imagem](./assets/5.png) |
| 6 | Na abertura da entrevista é feita uma apresentação sobre o entrevistador, a condução da sessão, duração, finalidade e o que será feito com as informações coletadas | Rafael Pereira, Renan Araújo | VÁZQUEZ, Carlos Eduardo; SIMÕES, Guilherme Siqueira. Engenharia de requisitos: software orientado ao negócio. 1. ed. Rio de Janeiro: Brasport, 2016. 328 p. ISBN 978-85-7452-790-1. | [Imagem](./assets/6.png) |
| 7 | Há a participação do cliente e/ou persona na entrevista. | Victor Hugo | VÁZQUEZ, Carlos Eduardo; SIMÕES, Guilherme Siqueira. Engenharia de requisitos: software orientado ao negócio. 1. ed. Rio de Janeiro: Brasport, 2016. 328 p. ISBN 978-85-7452-790-1. | [Imagem](./assets/7.png) |
| 8 | A entrevista foi gravada. | Victor Hugo, Renan Araújo | VÁZQUEZ, Carlos Eduardo; SIMÕES, Guilherme Siqueira. Engenharia de requisitos: software orientado ao negócio. 1. ed. Rio de Janeiro: Brasport, 2016. 328 p. ISBN 978-85-7452-790-1. | [Imagem](./assets/8.png) |
| 9 | É apresentado um termo de consentimento do entrevistado. | Victor Hugo | Barbosa, S. D. J.; Silva, B. S. da; Silveira, M. S.; Gasparini, I.; Darin, T.; Barbosa, G. D. J. (2021) Interação Humano-Computador e Experiência do usuário. Autopublicação. ISBN: 978-65-00-19677- | [Imagem](./assets/9.png) |
