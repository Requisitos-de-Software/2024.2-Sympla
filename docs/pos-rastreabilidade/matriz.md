...
| <a href="../../elicitacao/requisitos/requisitos_elicitados/#anchor_GERAL">RF22<a/> | RF | O aplicativo possui uma função que auxilia na recuperação da conta do usuário. | REF | Sim | ART | ELO |
